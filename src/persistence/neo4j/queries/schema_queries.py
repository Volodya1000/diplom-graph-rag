...
@dataclass
class CreateInstanceEmbeddingIndexQuery(Neo4jQuery):
    dim: int
...
@dataclass
class CreateChunkEmbeddingIndexQuery(Neo4jQuery):
    dim: int
...
@dataclass
class CreateInstanceNameIndexQuery(Neo4jQuery):
    def get_query(self) -> str:
        return """
...
@dataclass
class CreateSchemaClassNameIndexQuery(Neo4jQuery):
    def get_query(self) -> str:
        return """
...
@dataclass
class GetTboxClassesQuery(Neo4jQuery):
    def get_query(self) -> str:
        return """
            MATCH (c:SchemaClass)
...
@dataclass
class SaveTboxClassesQuery(Neo4jQuery):
...
@dataclass
class CreateSubclassOfEdgesQuery(Neo4jQuery):
    batch: List[Dict[str, Any]]
...
@dataclass
class GetSchemaRelationsQuery(Neo4jQuery):
    def get_query(self) -> str:
        return """
...
@dataclass
class SaveSchemaRelationsQuery(Neo4jQuery):
    batch: List[Dict[str, Any]]
...
@dataclass
class GetClassUsageCountsQuery(Neo4jQuery):
    def get_query(self) -> str:
        return """
